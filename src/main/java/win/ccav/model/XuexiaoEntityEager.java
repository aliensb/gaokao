...
public class XuexiaoEntityEager {
    private int id;
...
//    }
    ...
    public XuexiaoEntityEager(String diqu) {
        this.diqu = diqu;
    }
    public XuexiaoEntityEager(int id, String chengshi){
        this.chengshi=chengshi;
    }
    public XuexiaoEntityEager() {
    }
    ...
    public boolean equals(Object o) {
        ...
        XuexiaoEntityEager that = (XuexiaoEntityEager) o;
